...
Review correctness, bugs, edge cases, maintainability, reviewability, and concrete regression risk. Do not invent unsupported risks or consumers. Pre-existing
...
"quality"`, `severity`, `disposition`, `causality`, `confidence`,
