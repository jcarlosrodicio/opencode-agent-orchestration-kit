...
Review authentication, authorization, tenant isolation, secrets, sensitive logging, migrations, infrastructure, CI/CD, dependencies, and supply chain. Do not invent unsupported risks or consumers. Pre-existing
...
"security"`, `severity`, `disposition`, `causality`, `confidence`,
